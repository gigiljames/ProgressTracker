          ...
          <div className="bg-neutral-900 flex flex-col gap-5 h-fit border border-neutral-700 p-6 rounded-lg relative mt-15 min-w-100">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                ...
                <input
                  className={`border border-neutral-800 rounded-md p-2 text-neutral-300 h-14 mb-1 ${errors.title ? "ring ring-red-400" : ""} `}
                  type="text"
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  className={`border border-neutral-800 rounded-md p-2 text-neutral-300 w-full h-14 mb-1 ${errors.examDate ? "ring ring-red-400" : ""}`}
                  type="date"
                  value={examDate}
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  className={`border border-neutral-800 rounded-md p-2 text-neutral-300 min-h-25 mb-1 ${errors.desc ? "ring ring-red-400" : ""}`}
