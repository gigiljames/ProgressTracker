...
function AddSectionModal({ isOpen, onClose, onSubmit }: AddSectionModalProps) {
  ...
  function handleSubmit() {
    ...
    if (!title.trim()) {
      valid = false;
      newErrors.title = "Enter a valid section title";
    }

    if (!description.trim()) {
      valid = false;
      newErrors.description = "Enter a valid section description";
    }
