...
function AddTopicModal({ isOpen, onClose, onSubmit }: AddTopicModalProps) {
  ...
  function handleSubmit() {
    ...
    if (!title.trim()) {
      valid = false;
      newErrors.title = "Enter a valid topic title";
    }

    if (!description.trim()) {
      valid = false;
      newErrors.description = "Enter a valid topic description";
    }
