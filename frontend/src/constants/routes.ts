export const ROUTES = {
  ...
  TASKS: {
    ADD_TASK: (slotId: string) =>
      `/dashboard/slots/${slotId}/tasks`,
    EDIT_TASK: (slotId: string, taskId: string) =>
      `/dashboard/slots/${slotId}/tasks/${taskId}`,
  ...
  TOPICS: {
    GET_BY_CHAPTER: (chapterId: string) =>
